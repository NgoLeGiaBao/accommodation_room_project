...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Models.NewsModel.CategoryNews", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");

                    b.Property<string>("ContentNewsId")
                        .HasColumnType("text");
                    ...
                    b.ToTable("CategoryNewses");
                });

            modelBuilder.Entity("App.Models.NewsModel.ContentAndCategoryNews", b =>
                {
                    ...
                    b.HasKey("categoryNewsID", "contentNewsID");

                    b.HasIndex("contentNewsID");

                    b.ToTable("ContentAndCategoryNewses");
                });

            modelBuilder.Entity("App.Models.NewsModel.ContentNews", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("App.Models.ServicesModel.RooomInServiceBlog", b =>
                {
                    b.Property<string>("RooomInServiceBlogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ServicesBlogId")
                        .HasColumnType("text");
                    ...
                    b.HasKey("RooomInServiceBlogId");

                    b.HasIndex("ServicesBlogId");

                    b.ToTable("RooomInServiceBlogs");
                });

            modelBuilder.Entity("App.Models.ServicesModel.ServicesBlog", b =>
                {
                    b.Property<string>("ServicesBlogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("HasBedAndMattress")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("HasIndoorCleaning")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasKitchenShelf")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasLoft")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasPrivateParkingLot")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("NearBusStation")
                        .HasColumnType("boolean");

                    b.Property<bool>("NearGym")
                        .HasColumnType("boolean");

                    b.Property<bool>("NearHospital")
                        .HasColumnType("boolean");

                    b.Property<bool>("NearMarket")
                        .HasColumnType("boolean");

                    b.Property<bool>("NearPark")
                        .HasColumnType("boolean");

                    b.Property<bool>("NearSchool")
                        .HasColumnType("boolean");

                    b.Property<bool>("NearSupermarket")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("SelfManagedAccommodation")
                        .HasColumnType("text");

                    b.Property<decimal?>("Size")
                        .HasColumnType("numeric");

                    b.Property<string>("StatusBlog")
                        .HasColumnType("text");
                    ...
                    b.HasKey("ServicesBlogId");

                    b.ToTable("ServicesBlogs");
                });
            ...
            modelBuilder.Entity("App.Models.NewsModel.CategoryNews", b =>
                {
                    b.HasOne("App.Models.NewsModel.ContentNews", null)
                        .WithMany("CategoryNewses")
                        .HasForeignKey("ContentNewsId");

                    b.HasOne("App.Models.NewsModel.CategoryNews", "ParentCategory")
            ...
            modelBuilder.Entity("App.Models.NewsModel.ContentAndCategoryNews", b =>
                {
                    b.HasOne("App.Models.NewsModel.CategoryNews", "categoryNews")
                        .WithMany("PostCategories")
                        .HasForeignKey("categoryNewsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Models.NewsModel.ContentNews", "contentNews")
                        .WithMany("PostCategories")
                        .HasForeignKey("contentNewsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("contentNews");
                });

            modelBuilder.Entity("App.Models.NewsModel.ContentNews", b =>
                {
                    b.HasOne("App.Models.AppUser", "Author")
                        .WithMany("ContentNews")
            ...
            modelBuilder.Entity("App.Models.ServicesModel.RooomInServiceBlog", b =>
                {
                    b.HasOne("App.Models.ServicesModel.ServicesBlog", "ServicesBlog")
                        .WithMany("Rooms")
                        .HasForeignKey("ServicesBlogId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("ServicesBlog");
                });
